declare filename "fm3_LFO.dsp";
declare name "fm3_LFO";
import("stdfaust.lib");
...
operator(i, modInput1, modInput2, lfoIn) = 
    hgroup("op%i",
        (phaseMod(ba.midikey2hz(ba.hz2midikey(theFreq) + freqEnv), fbAmt, (modInput1 + modInput2)) 
        * amp
