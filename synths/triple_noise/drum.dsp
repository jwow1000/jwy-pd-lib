...
// envelope dx style
envelopeDX(g, i) = _ * hgroup("env%i", en.dx7envelope(aR, dR, sR, rR, aL, dL, sL, rL, gate @ delaySamps(del)))
with {
...
triple =
  _ <: par(i, 3, envelopeDX(gate, i)) :> _;

process = no.noise * 0.3 : fi.resonbp(freq,2,0.5) : triple;